                ...
                <Row>
                    ...
                    <Col xs='12' md='10'>
                        ...
                        <Typography variant='body1' marginTop='2%'>
                            I'm a Full-Stack Software Engineer currently looking for work. Most recently, I held the position of Software Engineer 1 at WoodMackenzie, where I worked primarily with Typescript and React, and interfaced occasionally with Java and Python as well. I enjoy having a broad width of knowledge, and put a lot of emphasis into picking up wide variety of work, whilst still maintaining areas of expertise. I am a fast learner, an eager volunteer, and an active participant in team discussions and decision making. At WoodMackenzie, I also acted as a co-op manager and I continuously supported the co-op program through onboarding planning and conducting interviews. For more information on my experience, check out my <a href='/work-experience' className="pageLinks">Work Experience</a> and <a href='/projects' className="pageLinks">Projects</a> pages!
                        </Typography>
